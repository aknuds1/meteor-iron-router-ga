...
var attachAnalyticsOptions = function attachAnalyticsOptions(options) {
    options = options || {};
    var shouldTrackPageView = (options && options.trackPageView != null) ?
        !!options.trackPageView : (!!this.options && !!this.options.trackPageView);
    if (shouldTrackPageView) {
        attachPageViewTracking.call(this, options);
    }
    attachPageSetter.call(this, options);
    if (!!options.contentExperiment || !!options.gaContentExperiment) {
...
Router.route = function route(name, handler, options) {
    if (options == null) {
    ...
    attachAnalyticsOptions.call(this, options);
    if (handler == null) {
        handler = options;
    }
    return originalRoute.call(this, name, handler, options);
};
